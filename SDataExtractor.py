...
# MAIN SCRIPT
####################################
# WE NEED A LIST OF DATA PAPER OF SD
# Reading previous results
df = pd.read_csv('SData/SDataPapersList.csv')

with open('SData/ResultsSData.csv', 'w', newline='') as output_file:
    results = []
    for index, data_paper in df.iterrows():
        ...
        if index > 0:
            ...
            output_path = "SData/ResultsSData.csv"
